...
class EpisodeMetrics:
    ...
    landing_x: Optional[float]    # landing position
    landing_y: Optional[float]
    prediction_error: Optional[float]  # meters, at contact time
    reward: float
...
class EvalLogger:
    ...
    def __init__(self, log_path: Optional[str], config: Optional[dict]):
        """
        Args:
